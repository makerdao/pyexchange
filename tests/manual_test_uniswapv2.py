...
remove_eth_amounts = {
    ...
    "amountTokenMin": web3.toWei(0.124273, 'ether'),
    "amountETHMin": web3.toWei(0.000512356, 'ether')
}
# time.sleep(20)
# transaction = uniswap.remove_liquidity_eth(DAI_ADDRESS, remove_eth_amounts)
# res = transaction.transact(from_address=Address(web3.eth.defaultAccount))
# print(res)
# print(res.transaction_hash.hex())
