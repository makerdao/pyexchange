...
dai_weth_kovan_pair_address = uniswap.get_pair_address(DAI_KOVAN_ADDRESS.address, WETH_KOVAN_ADDRESS.address)
print(dai_weth_kovan_pair_address)

dai_weth_kovan_exchange_rate = uniswap.get_exchange_rate(dai, weth)
