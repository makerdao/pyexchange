...
# print("place order")
# print(kucoin.place_order("ETH-DAI", False, Wad.from_number(60.11111111111), Wad.from_number(0.0156547676576)))
# print("get coin balance")
# print(kucoin.get_fiat_balance("USD"))
print("get our trades")
print(kucoin.get_trades("ETH-DAI"))
print("get all trades")
print(kucoin.get_all_trades("ETH-DAI"))
# print("cancel order")
# print(kucoin.cancel_order("5c135659335e7e767b82f7ce", False, "ETH-DAI"))
# print("get orders")
